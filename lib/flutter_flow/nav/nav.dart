...
class AppStateNotifier extends ChangeNotifier {
  ...
  AhgJobRepositoryFirebaseUser user;
  ...
  void update(AhgJobRepositoryFirebaseUser newUser) {
    initialUser ??= newUser;
    user = newUser;
        ...
        FFRoute(
          ...
          routes: [
            ...
            FFRoute(
              name: 'newHomefeed',
              path: 'newHomefeed',
              builder: (context, params) => NewHomefeedWidget(),
            ),
            FFRoute(
              name: 'newApplicantList',
              path: 'newApplicantList',
